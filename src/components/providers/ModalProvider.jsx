...
export const ModalProvider = ({children}) => {
  ...
  return (
    <ModalContext.Provider value={{showReservTableModal, setShowReservTableModal, handleShowReservTableModal, handleHideReservTableModal}}>
        {children}
...
return (
  <ModalNavigate.Provider value={{showNavigateModal, setShowNavigateModal, handleShowNavigateModal, handleHideNavigateModal}}>
      {children}
