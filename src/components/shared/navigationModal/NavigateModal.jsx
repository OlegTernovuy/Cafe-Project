      ...
      return (
          <div className="navModal">
            ...
            <Link to='/' onClick={handleHideNavigateModal}>
                ...
                <ul>
                    <li>
                        <Link to="/foodMenu" onClick={handleHideNavigateModal}>Меню</Link>
                    </li>
                    <li>
                        <Link to="/delivery" onClick={handleHideNavigateModal}>Доставка</Link>
                    </li>
                    <li>
                        <Link to="/" onClick={handleHideNavigateModal}>Оплата</Link>
                    </li>
                </ul>
            <button onClick={closeAllModal} className='reservedBtn'>Бронювання</button>
          </div>
  )
}
